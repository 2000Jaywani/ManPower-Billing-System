...
<asp:Content ID="Content4" ContentPlaceHolderID="cph_righrbody" runat="Server">
 ...
 <asp:HiddenField ID="hidtab" Value="0" runat="server" />
                            ...
                            <li id="tabactive5" class="active"><a data-toggle="tab" href="#menu1">Fire Extinguisher Details</a></li>
                                 <li id="Li2" class="active"><a data-toggle="tab" href="#menu3">Feedback Letter</a></li>
                  ...
                  <br />
                        ...
                        <asp:TextBox runat="server" ID="txt_search" CssClass=" form-control" onkeyup="Search_Gridview(this)" />
                                ...
                                <ItemTemplate>
                                 ...
                                 <div class="row text-center">
                                 <asp:Button ID="btn_approve_fire" runat="server" OnClick="btn_approve_fire_Click" class="btn btn-primary" Width="8%" OnClientClick="return  fire_approve(); " Text="APPROVE" />
       ...
       <div id="menu3" >
                        ...
                        <%--<asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">--%>
                           <%-- <ContentTemplate>--%>
                                ...
                                <asp:DropDownList ID="ddl_client_name" class="form-control pr_state js-example-basic-single" runat="server" OnSelectedIndexChanged="ddl_client_name_SelectedIndexChanged" AutoPostBack="true">
                                    ...
                                    <div class="col-sm-2 col-xs-12 ">
                              <b>  State Name :</b>
                             <asp:DropDownList ID="ddl_state_name" runat="server"  class="form-control pr_state js-example-basic-single" OnSelectedIndexChanged="ddl_state_name_SelectedIndexChanged" AutoPostBack="true">
                 </asp:DropDownList>
                            </div>   
                ...
                <asp:TextBox ID="txt_monthyear" runat="server" CssClass="form-control date-picker" />
                                    ...
                                    <div class="col-sm-2 col-xs-12" style="margin-top: 1.5em">
                                        <asp:Button ID="btn_send_feedback_link" runat="server" class="btn btn-primary" OnClick="btn_send_feedback_link_Click" Text="Send Feedback Link" OnClientClick="return Req_validation1();" Style="width:200px;" />
                                    </div>
                                    <div class="col-sm-2 col-xs-12" style="margin-top: 1.5em">
                                        <asp:Button ID="btn_get_report" runat="server" class="btn btn-primary" OnClick="btn_get_report_Click" Text="Report" OnClientClick="return valid_email();" Style="width:150px;"  />
                                    </div>
                                    <br />
                                </div>
                                <br />
