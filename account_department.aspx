<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="account_department.aspx.cs" Inherits="account_department" EnableEventValidation="false" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph_title" runat="Server">
    <title>Accounts_department Approval</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_righrbody" runat="Server">
    ...
    <div class="container-fluid">
        <asp:Panel ID="Panel3" runat="server" CssClass="panel panel-primary" Style="background-color: white;">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <div style="color: #fff; font-size: small;" class="text-center text-uppercase"><b>Accounts_department Approval</b></div>
                    </div>
        ...
        <asp:GridView ID="gv_cash_voucher" class="table" runat="server" BackColor="White"
                        ...
                        AutoGenerateColumns="false" Width="110%" >
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Debited To" >
                                <ItemTemplate>
                                    <asp:DropDownList ID="ddl_debt_to" runat="server" CssClass="form-control text_box" Width="100%" >
<%--                                        <asp:ListItem Value=""></asp:ListItem>--%>
                                        <asp:ListItem Value="OFFICE EXPENSES">OFFICE EXPENSES</asp:ListItem>
                                        <asp:ListItem Value="LEGAL EXPENSES">LEGAL EXPENSES</asp:ListItem>
                                        <asp:ListItem Value="COMPUTER_PRINTER EXPENSES">COMPUTER_PRINTER EXPENSES</asp:ListItem>
                                        <asp:ListItem Value="TRAVELLING EXPENSES">TRAVELLING EXPENSES</asp:ListItem>

                                        <asp:ListItem Value="FOOD AND REFRESHMENT EXPENSES">FOOD AND REFRESHMENT EXPENSES</asp:ListItem>
                                        <asp:ListItem Value="POSTAGE AND TELEGRAM EXPENSES">POSTAGE AND TELEGRAM EXPENSES</asp:ListItem>
...
<%--                            <asp:BoundField DataField="narration" HeaderText="Narration" SortExpression="narration" />--%>
                             <asp:TemplateField HeaderText="Narration">
                                           <ItemTemplate>
                                            <asp:TextBox runat="server" ID="narration" Text='<%# Eval("narration") %>' Width="180px" CssClass="form-control" onkeypress=" return alphanumeric(event)"></asp:TextBox>
                                        </ItemTemplate>
                            ...
                            <asp:TemplateField >
                             ...
                             <asp:TemplateField>
                                        <ItemTemplate>
<%--                                            <asp:LinkButton ID="btn_edit" Text="Edit" runat="server" CssClass="btn btn-primary" Style="color:white"  ></asp:LinkButton>--%>
                                        </ItemTemplate>
                            </asp:TemplateField>
